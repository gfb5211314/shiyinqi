...
{
   HAL_UART_Receive_DMA(&bsp_usart1,(uint8_t *)BSP_UASRT1_ST.RX_pData, 1000);  //??????
...
//			 printf("2");
			  for(uint16_t i=0;i<500;i++)
			 {
				er8[i+500]= BSP_UASRT1_ST.RX_pData[i+500];
			 }
...
//		 }
	  HAL_UART_Transmit_DMA(&huart2,(uint8_t *)er8, 1000);
		   count_flaf1=0;
	 }
//	 if(count_flaf2==1)
//	 {
